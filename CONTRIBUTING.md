...
Contributions are welcome. We accept pull requests on [GitHub](https://github.com/updivision/matrix-php-sdk).

This project adheres to a [Contributor Code of Conduct](https://github.com/updivision/matrix-php-sdk/blob/master/CODE_OF_CONDUCT.md). By participating in this project and its community, you are expected to uphold this code.

## Team members

* [Alin Ghitu](https://github.com/Ghitu) - original author and maintainer

## Reporting Bugs

Bugs are tracked in our project's [issue tracker](https://github.com/updivision/matrix-php-sdk/issues).
